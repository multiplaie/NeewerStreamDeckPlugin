...
function connectElgatoStreamDeckSocket(inPort, inUUID, inRegisterEvent, inInfo, inActionInfo) {
	...
	websocket.onopen = function () {
		...
		document.getElementById('l1-l-temp').value = settingsModel.L1LightnessTemperature;
		document.getElementById('l2-l-temp').value = settingsModel.L2LightnessTemperature;
